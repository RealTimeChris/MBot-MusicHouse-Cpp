// Seek.hpp - Header for the "seek" command.
// Sep 9, 2021
// Chris M.
...
namespace DiscordCoreAPI {
	...
	class Seek : public BaseFunction {
	  public:
		Seek() {
			this->commandName = "Seek";
			this->helpDescription = "Seek to a chosen point within a currently playing song.";
			EmbedData msgEmbed;
			msgEmbed.setDescription("------\nSimply enter /seek MINUTES, SECONDS into the song which you would like to seek.\n------");
			msgEmbed.setTitle("__**Seek Usage:**__");
